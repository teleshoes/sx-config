...
Item {
    ...
    ClockItem {
        ...
        font {
            pixelSize: largeScreen ? Theme.fontSizeHuge * 2.0 : Math.round(128 * Screen.widthRatio)
    ...
    Text {
        ...
        color: timeText.color
        font {
            pixelSize: largeScreen ? Theme.fontSizeExtraLarge * 1.1 : Math.round(55 * Screen.widthRatio)
            family: Theme.fontFamily
        }
